...
export { default as DetailLanguagesView } from './DetailLanguagesView'
export { default as DetailMediaTypeView } from './DetailMediaTypeView'
export { default as DetailMoviesView } from './DetailMoviesView'
export { default as DetailPlatformView } from './DetailPlatformView'
